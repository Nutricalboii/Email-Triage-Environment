# 🏆 Winning Edge: 2-Minute Pitch Script
### OpenEnv Email Triage Assistant (Team Singularity)
...
## 🎭 0:30 - 1:15 | The Adversarial Showdown (Live Demo)
**You:** “We’re running our specialized **Adversarial Showdown**. Look at these two emails.” 
...
**You:** *(Highlighting the fail score)*
“A standard agent fails this test. Our environment rewards the **contextual intelligence** to ignore the noise and address the outcome.”
...
## 🏁 1:45 - 2:00 | The Closer
**You:** “We didn’t just build a dashboard. We built an adversarial testbed that distinguishes between an agent that **follows instructions** and an agent that **adds value**. 

This is the OpenEnv Email Triage Assistant. We’re ready for the leaderboard.”

---

### 💡 Pro-Tips for the Pitch:
- **Don’t Read**: Use these as talking points. Maintain eye contact with the "judges" (or the camera).
- **Emphasize 'Trust'**: Judges worry about over-engineered or biased scoring. Emphasize the **Trust Clause** in the documentation.
- **The Mic Drop**: When you show the agent failing the "Pizza Trap", pause for a second. Let the mistake sink in before you show your correct system score.
